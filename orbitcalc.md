...
太陽定数を $ 2kw/m^2 $として、効率10%で地上に送電できるとして、1テラワットを賄うためには  $10km \times 10km$ の 太陽発電衛星がどれだけ必要でしょう。
...
ここの計算は、当初 H2A で計算していました。
H2A のコストはブースター4基で4.6トンを打ち上るとして、コスト120億円。
さすがに高すぎました。

その後、H3 や 再利用型 ファルコン9 が登場しています。改めて、ファルコン 9 ブロック5 で宇宙へのコストを計算してみましょう。LEO への打ち上げ能力は 22 トン。打ち上げコストは6700万ドル<span class=pin>[^Falcon9]</span>。
...
今回、演習編の解凍を作成しました。 解答は以下 Wiki に掲載しています。
...
2023.03.02  08:30:00  know me... を聞きながら
