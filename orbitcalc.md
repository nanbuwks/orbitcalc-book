<img alt="picture 2" src="images/199072d66a5d721d3410c444b90fca2a0defb839b21806642e01caee43ccf9aa.png" width="610" />
...
![スペースコロニーの内部](./images/Internal_view_of_the_ONeill_cylinder.jpg  "スペースコロニーの内部" )
...
2019年の世界のエネルギー消費量は、169億toe（原油換算トン）でした[^1]。将来200億tocとして、その10%を賄うとすれば、太陽発電衛星はどれだけ必要でしょうか。

[^1]: 令和2年度エネルギーに関する年次報告（エネルギー白書2021）

太陽発電衛星の１平方メートルあたり、$ 100g $ だとします。$ 10km \times 10km $の太陽発電衛星の質量はどれだけになるでしょう。
### 回答？
...
![国際宇宙ステーション](./images/STS-134_International_Space_Station_after_undocking.jpg  "国際宇宙ステーション" )
...
C99版からあまり進めてなくて改訂箇所はほんのちょっとです。前回に引き続き VSCode で執筆、印刷するようにしていますが前回の環境を再現しようとしたらどうなってたか忘れていて再現にかなり時間がかかってしまいました。

![ロータベータ](./images/rotavator1.png  "ロータベータ" )
(ロータベータ)

【THE SIXTH LIE】「Hibana」を聞きながら〜  2022/08/13 06:26
